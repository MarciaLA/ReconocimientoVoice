...
# Convertir los comandos almacenados en vectores numéricos utilizando one-hot encoding
...
try:
    ...
    print("Comando de entrada:", frase_entrada)
    ...
    print("Comando similar encontrado:", frase_similar)
